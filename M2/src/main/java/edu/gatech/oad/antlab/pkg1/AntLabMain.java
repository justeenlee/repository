    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  //and gburdell1 with your gt id
	          Person1 p1 = new Person1("Allie Giddings");
		  toPrint += p1.toString("agiddings6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Anna Laura Davenport");
		  toPrint += p2.toString("adavenport9");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Cole Bowers");
		  toPrint += p3.toString("cbowers40");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Zhendong Li");
                  toPrint += p4.toString("zli343");
...
=======
                  Person5 p5 = new Person5("Steven Wulber");
                  toPrint += p5.toString("swulber3");
